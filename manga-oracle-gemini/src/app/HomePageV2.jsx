    ...
    >
      ...
      <main className="md:h-[calc(100vh-60px)] md:overflow-hidden">
        <section className="relative overflow-hidden border-b border-black/10 md:h-[31vh] md:min-h-[270px] md:max-h-[320px]">
          ...
          />
          <div className="relative mx-auto grid h-full max-w-[1920px] items-center gap-2 px-6 pb-7 pt-7 md:grid-cols-[0.32fr_0.68fr] md:px-7 md:pb-4 md:pt-4 xl:px-8 2xl:px-10">
            <div className="flex flex-col justify-center">
              <div className="mb-2 text-sm font-extrabold tracking-[0.02em] text-[#c0392b]" style={{ fontFamily: homeSans }}>AIがあなたの好みを分析</div>
              <h1 className="mb-3 text-4xl font-bold leading-tight tracking-normal sm:text-5xl md:text-5xl xl:text-[3.55rem]" style={{ fontFamily: homeSerif, fontWeight: 700 }}>
              ...
              <p className="mb-4 max-w-2xl text-base font-medium leading-7 md:text-[14px] xl:text-[15px]" style={{ color: "#222", fontFamily: homeSans }}>
              ...
              <div className="flex flex-col gap-3 sm:flex-row">
                <button
                  type="button"
                  onClick={onStartQuiz}
                  className="rounded-[6px] bg-[#c0392b] px-8 py-3 text-center text-sm font-bold text-white shadow-[0_10px_20px_rgba(192,57,43,0.18)] transition-transform hover:-translate-y-0.5"
                >
                  診断を始める →
                </button>
                <a
                  href="/manga"
                  className="rounded-[6px] border border-black/25 bg-white/70 px-8 py-3 text-center text-sm font-bold transition-transform hover:-translate-y-0.5"
                >
                  漫画を探す →
                </a>
              </div>
        ...
        <section className="mx-auto hidden max-w-[1920px] px-6 pb-2 pt-1 md:px-7 xl:px-8 2xl:px-10">
